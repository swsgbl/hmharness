...
const zh: Strings = {
  ...
  tuiHints: 'enter 发送 · ↑↓ 历史 · esc 清空 · 滚轮/pgup 翻页 · 拖选复制 · ^C 退出 · /help 命令',
  mouseOff: '关闭滚轮接管',
  ...
  cmdMouse: '切换滚轮接管(默认开:滚轮翻页+拖选复制并存)',
...
const en: Strings = {
  ...
  tuiHints: 'enter send · ↑↓ history · esc clear · wheel/pgup scroll · drag to copy · ^C quit · /help',
  ...
  cmdMouse: 'toggle wheel capture (on by default: wheel scrolls AND drag still copies)',
